...
- targets_overrides — если названы конкретные этажность, плотность или число жителей.

Число жителей сервис считает сам — от площади кварталов и нормативной плотности,
на максимум в допустимых пределах. Не спрашивай его и не придумывай.
